				...
				<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
					<div class="footer_qlink_widget">
						...
						<ul class="list-unstyled">
							...
							<li><a href="{{ route('listar') }}">Automoveis</a></li>
				...
				<div class="col-lg-6 col-xl-6">
					<div class="footer_menu_widget">
						<ul>
							...
							<li class="list-inline-item"><a href="{{ route('sobre') }}">Sobre nós</a></li>
							<li class="list-inline-item"><a href="{{ route('listar') }}">Automoveis</a></li>
							<li class="list-inline-item"><a href="{{ route('contato') }}">Contato</a></li>
							<li class="list-inline-item"><a href="{{ route('favoritos') }}">Favoritos</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-6 col-xl-6">
