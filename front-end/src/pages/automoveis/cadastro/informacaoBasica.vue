            ...
            <VForm class="mt-6">
              <VRow>
                ...
                <VCol cols="12" md="4">
                  ...
                  <VSelect
                    v-model="item.tipo_automovel_id"
...
const onInput = (event) => {
  ...
  props.item.valor = sanitizedValue;
};
...
const validate = computed(() => {
  if (
    ...
    props.item.tipo_automovel_id == null ||
    props.item.categoria_id == null ||
    props.item.ano == null ||
    props.item.marca_id == null ||
    props.item.modelo_id == null
  ) {
    if (props.item.nome == "") {
