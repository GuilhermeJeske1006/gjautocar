...
@section('corpo')
	...
	<section class="our-listing bgc-f7 pb30-991">
		<div class="container">
			@component('automovel.apoio.filtro-mobile', ['site' => $site, 'marcas' => $marcas, 'categorias' => $categorias])
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="breadcrumb_content style2 mb0-991">
						<ol class="breadcrumb">
						    <li class="breadcrumb-item"><a href="{{ route('index', ['id' => $site->id]) }}">Home</a></li>
			...
			<div class="row">
				<div class="col-lg-4 col-xl-4">
					<div class="sidebar_listing_grid1 dn-991">
						@component('automovel.apoio.filtro', ['site' => $site, 'marcas' => $marcas, 'categorias' => $categorias])@endcomponent
						...
						<div class="sidebar_feature_listing">
							...
							@component('automovel.apoio.mini-card', ['site' => $site, 'item' => $recen])@endcomponent
								...
								<div class="right_area text-right tac-xsd">
									<ul>
										...
										<li class="list-inline-item">
											<form action="{{ route('listar', ['id' => $site->id]) }}" method="GET" id="seuForm">
