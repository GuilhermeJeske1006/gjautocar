                ...
                <div class="home_content">
                    ...
                    <div class="home_adv_srch_opt">
                        ...
                        <div class="tab-content home1_adsrchfrm" id="pills-tabContent">
                            <form method="GET" action="{{ route('listar', ['id' => $item->id]) }}" class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <form method="GET" action="{{ route('listar', ['id' => $item->id]) }}" class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="home1-advnc-search">
                                    <ul class="h1ads_1st_list mb0">
