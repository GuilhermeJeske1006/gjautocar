...
@section('corpo')
	@component('components.banner-interno', ['item' => $item, 'title' => 'Contato'])@endcomponent
			...
			<div class="row">
				<div class="col-lg-7 col-xl-8">
					<div class="form_grid">
			            ...
			            <form class="contact_form" id="contact_form" name="contact_form" action="{{ route('enviar_contato', ['id' => $item->id]) }}" method="post" novalidate="novalidate">
							@csrf
							<div class="row">
				                <div class="col-md-6">
	...
	@component('components.anuncie', ['site' => $item])@endcomponent
