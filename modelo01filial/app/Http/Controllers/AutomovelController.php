...
class AutomovelController extends Controller
{
    public function index($id, Request $request){
        ...
        $data = ApiHelper::getDataFromApi($id, $request->search, $request, $request->ordenacao);
    ...
    public function show($id_empresa, $id){
        ...
        $data = ApiHelper::getDataFromApi($id_empresa);
        $dataObj = json_decode($data);
    ...
    public function favoritos($id_empresa) {
    ...
    public function enviarInteresse($id_empresa, Request $request){
