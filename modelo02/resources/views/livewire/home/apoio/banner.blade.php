                ...
                <div class="col-lg-12">
                    <div class="home_content home6">
                        <div class="home-text home6 text-center">
                            <h2 class="fz55">{{ $site->nome }}</h2>
                            <p class="fz18">{{ $site->titulo }}</p>
                        </div>
                                        ...
                                        <ul class="h1ads_1st_list mb0">
                                            ...
                                            <li class="list-inline-item">
                                                <div class="form-group">
                                                    <input style="width: 142px;" type="text" class="input-responsive2 form-control" name="ano" placeholder="Ano">
                                                </div>
                                            </li>
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div class="home1-advnc-search home6">
                                        <ul class="h1ads_1st_list mb0">
                                            ...
                                            <li class="list-inline-item">
                                                <div class="form-group">
                                                    <input style="width: 910px;" type="text" class="input-responsive form-control" name="search" placeholder="Faça a sua busca pelo nome">
                                                </div>
                                            </li>
